...
const makeProject = (headerText, sourceCodeLink, descriptionText, projectText, projectLink, demoText, demoLink) => {
...
export default function DisplayProjects () {
	...
	projects.appendChild(makeProject("ShootLasers", "https://github.com/Electromorphous/SpaceShooter", "A space-shooter game made in Unity using C#. This was only made to gain some experience in Unity, not necessarily for games.", "Play on itch.io", "https://electromorphous.itch.io/shoot-lasers", "Play now in the browser!", "../ShootLasers/index.html"));
	projects.appendChild(makeProject("FlaskUnityApp", "https://github.com/Electromorphous/FlaskUnityApp", "A web app made in python and flask that takes Unity WebGL build folders which are compressed to zip files, extracts them and plays the game in the browser."));
